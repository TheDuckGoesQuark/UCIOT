...
Security was not considered at all when desigining this protocol, which definitely makes it unsuitable for many situations. It relies heavily on all control messages being limited, and on the honesty of nodes. For example, if a node with plentiful energy wished to process less network traffic, it could advertise itself as having low energy reserves and be the least likely candidate for forwarding.

The project sufferred due to taking too long to settle on a design, but the process of considering and attempting different variations on ad-hoc routing protocols was very educational.
