...
Initially, each node would broadcast its presence to its neighbours in order to learn what links were available to it using a \emph{Join} message. 

Once the entire local network topology is available, data packets would be routed using the following logic:
